...
if __name__ == "__main__":
    ...
    for sim_dir in sim_dirs:
        ...
        for ds in reversed(ts):
            ...
            print '\nFindig galaxy properties for snapshot ', ds.parameter_filename.split('/')[-1]
            print ''
            ...
            halo_rs = ds.arr(mmpb_props['rs'][idx], 'kpccm/h')
            ...
            sc_sphere =  ds.sphere(stars_center, 3.0*halo_rs)
            try:
            ...
            gc_sphere =  ds.sphere(gas_center, 3.0*halo_rs)
